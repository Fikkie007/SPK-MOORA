...
<div class="container-fluid">
    ...
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            <li class="breadcrumb-item"><a href="<?= base_url(); ?>hrd/kelola_karyawan">Kelola Pemain Bola</a></li>
            <li class="breadcrumb-item active" aria-current="page">Form Tambah Pemain Bola</li>
        </ol>
    </nav>
    ...
    <div class="card shadow mb-4">
        <div class="card-header py-3">
            <h6 class="m-0 font-weight-bold text-info"> Form Tambah Pemain Bola</h6>
        </div>
        <div class="card-body">
